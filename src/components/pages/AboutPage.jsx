...
export default function AboutPage() {
    return (
        <div className="relative w-screen min-h-screen bg-gradient-to-b from-[#020305] to-[#060a0f] overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(0,120,255,0.25),transparent_60%),radial-gradient(ellipse_at_70%_80%,rgba(0,150,255,0.15),transparent_70%)] blur-3xl"></div>
            <div className='min-h-screen h-auto relative' id="About">
                <div className='w-screen h-full min-h-screen bg-gradient-to-b from-[#030507] via-[#03050709] to-[#030507]'>
