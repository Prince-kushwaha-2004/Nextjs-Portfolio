            ...
            <div className={`w-screen min-h-screen  relative`} id="Home">
                ...
                <div className='flex  w-screen h-screen' >
                    <div className='w-full px-4 lg:px-40 2xl:px-60 flex flex-col justify-center z-[10]'>
                        <h1 className="text-3xl sm:text-5xl 2xl:text-6xl font-bold text-white">Hi There,</h1>
                        <h1 className="text-3xl mt-4 sm:text-5xl 2xl:text-6xl font-bold text-white"> I'm{" "}
                        ...
                        <div className="text-md sm-text-lg 2xl:text-xl mt-16 text-gray-300 w-full lg:w-2/3 ">
